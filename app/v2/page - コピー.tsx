        ...
        <div className="mx-auto flex min-h-screen w-full max-w-md flex-col px-4 pb-36 pt-5">
          <header className="mb-5">
            <div className="mb-3 flex items-center justify-between">
              <div>
                <button
                  ...
                  className="mb-2 rounded-full bg-white px-3 py-1 text-xs font-bold text-sky-500 shadow-sm"
                >
                  レッスン一覧
                </button>
            ...
            <button
              ...
              className="mb-3 w-full rounded-2xl bg-white py-3 text-sm font-black text-sky-500 shadow-sm"
            >
              レッスンを変更
            </button>
